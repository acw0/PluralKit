...
namespace PluralKit.Core
{
    public class MemberPatch: PatchObject
    {
        ...
        protected bool Equals(MemberPatch other) => 
            ...
            && ProxyTags.Equals(other.ProxyTags)
            && KeepProxy.Equals(other.KeepProxy)
            && MessageCount.Equals(other.MessageCount)
            && Visibility.Equals(other.Visibility)
            && NamePrivacy.Equals(other.NamePrivacy)
            && DescriptionPrivacy.Equals(other.DescriptionPrivacy)
            && PronounPrivacy.Equals(other.PronounPrivacy)
            && BirthdayPrivacy.Equals(other.BirthdayPrivacy)
            && AvatarPrivacy.Equals(other.AvatarPrivacy)
            && MetadataPrivacy.Equals(other.MetadataPrivacy);
