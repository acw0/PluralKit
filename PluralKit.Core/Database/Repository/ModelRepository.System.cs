...
namespace PluralKit.Core
{
    public partial class ModelRepository
    {
        ...
        public Task<PKSystem?> GetSystemByGuid(IPKConnection conn, Guid guid) =>
            conn.QueryFirstOrDefaultAsync<PKSystem?>("select * from systems where uuid = @Uuid", new {Uuid = guid});
